...
tshark_pipe = "tshark -l -i - -E separator=\";\" -Y 'tetra.MAC_END_DOWNLINK_element or tetra.MAC_FRAG_element or tetra.d_SDS_Data_element or tetra.u_SDS_Data_element' -T fields -e tetra.pdu -e gsmtap.arfcn -e gsmtap.ts -e frame.number 2>/dev/null"
